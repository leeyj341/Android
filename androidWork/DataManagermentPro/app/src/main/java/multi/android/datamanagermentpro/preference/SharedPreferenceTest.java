package multi.android.datamanagermentpro.preference;
...
public class SharedPreferenceTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor = setting.edit();    //설정 정보를 기록할 때 필요한 매체

        //설정 정보가 저장된 xml에서 값을 읽어와서 초기화
        first_edit.setText(setting.getString("first", "")); // xml태그와 사이 value
