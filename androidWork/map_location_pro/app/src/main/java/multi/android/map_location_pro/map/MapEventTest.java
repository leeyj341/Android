...
/*
지도화면이 출력된 후에 이벤트를 연결할 수 있어야 한다. 지도를 클릭하거나 지도를 드래그,
지도의 줌레벨 버튼을 이용해서 줌레벨을 변경
    OnMapClickListener => 지도를 클릭할 때 발생하는 이벤트에 대한 처리
    OnMapLongClickListener => 맵을 길게 꾸욱 눌렀을 때 발생하는 이벤트에 대한 처리
...
public class MapEventTest extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapClick(LatLng latLng) {
        map.clear();
        Toast.makeText(this, "지도를 클릭했습니다. => " + "위도:" + latLng.latitude + ", 경도:" + latLng.longitude, Toast.LENGTH_SHORT).show();
    ...
    public void onMapLongClick(LatLng latLng) {
        Toast.makeText(this, "지도를 길게 클릭했습니다. => " + "위도:" + latLng.latitude + ", 경도:" + latLng.longitude, Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onCameraMove() {
        Toast.makeText(this, "카메라가 이동됩니다.", Toast.LENGTH_LONG).show();
    }

    @Override
    public void onCameraMoveStarted(int i) {
        Toast.makeText(this, "카메라가 이동 시작.", Toast.LENGTH_LONG).show();
    }
}
